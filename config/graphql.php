...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'student' => \App\GraphQL\Queries\Quest\QuestQuery::class,
                'students' => \App\GraphQL\Queries\Quest\QuestsQuery::class,
            ],
            'mutation' => [
                'createStudent' => \App\GraphQL\Mutations\Quest\CreateQuestMutation::class,
                'updateStudent' => \App\GraphQL\Mutations\Quest\UpdateQuestMutation::class,
                'deleteStudent' => \App\GraphQL\Mutations\Quest\DeleteQuestMutation::class,
            ],
            'middleware' => [],
            'method' => ['get', 'post'],
        ],
